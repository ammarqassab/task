...
const Footer = () => {
    return (
        <footer className="padding textc-2 bgc-3 rtl" >
            <hr className=' borderc-4'/>
            <div className='row' >
                <div className='col m50' >
                    <h2 className=' xxlarge textc-2'><ApplicationLogo/></h2>
                </div>
                <div className='col m50 user-select padding' >
                    <h2 className="textc-2 xlarge" >تواصل معنا :</h2>
                ...
                <div className='col m50 padding' >
                    <h2 className='textc-2 xlarge'>حول موقعنا :</h2>
